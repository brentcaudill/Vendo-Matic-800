...
This app fuctions as a Vending Machine Interface. It allows customers to purchase products of their choice and logs the transaction history.

## Features

- The vending machine reads its inventory from an input file when the vending machine starts
- it displays a menu to the user
- ability to receive and hold dollar amounts for a user to buy multiple items
